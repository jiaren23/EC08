<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EC08two.aspx.cs" Inherits="EC08two" %>
<!DOCTYPE html>
 ...
 <title>福克斯 Focus - 商品資訊</title>
    ...
    <body>
        <form id="form1" runat="server">    
            ...
            <div class="ribbon">                
                <img src="images/logo2.jpg" width="100"/><asp:ImageButton ID="Product_II" runat="server" ImageUrl="images/ribbon_img4.png" Width="350" OnClick="Product_II_Click"/>
            </div>
            <br/>
            <br/>
            <br/>
